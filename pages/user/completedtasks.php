...
<div class="container">
    ...
    <table class="table table-dark table-striped">
        ...
        for ($i = 0; $i < $num_results; $i++) {
            ...
            <td><a class="butten" href= view.php?ID= <?php echo urldecode($row['id']) ;?> >View</a></td>
            <td><a class="butten" href= delete.php?ID= <?php echo urldecode($row['id']) ;?> >Delete</a></td>
            </tr>
...
<script>
    ...
    function updateStatus() {
        ...
        var u = document.getElementById('validationDefaultUsername').value;
        var myRequest;
        // feature check!
        ...
        // open and send it
        myRequest.open("GET", "checkTU.php?username=" + u +"+id="+"", true);
        // any parameters?
        myRequest.send(null);
    }
